...
module.exports = client => {
    ...
    http.listen(settings.config.http.port, () => {
        ...
        console.log(`┃`.bold.brightGreen,`📗: Website is online`.bold.green)
        console.log(`┃`.bold.brightGreen,`\x1b[36m📘: ${String(new Date).split(" ", 5).join(" ")}`.bold)
        console.log(`┃`.bold.brightGreen,`\x1b[31m📙: [${settings.website.domain}]`.bold)
        console.log(`┃`.bold.brightGreen,`📕: HTTP-Website running on ${settings.config.http.port} port.`.bold.magenta)
        console.log(`┃`.bold.brightGreen,`\x1b[30m📓: ${client.user.tag} Bot is online`.bold)
        console.log(`▣━━━━━━━━━━━━━···`.bold.brightGreen)
    });
}