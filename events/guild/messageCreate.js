...
module.exports = async (client, message) => {
    ...
    if(!cmd || cmd.length == 0){
        if(mPrefix.includes(client.user.id)){
            message.reply({embeds: [new Discord.MessageEmbed().setColor(ee.color).setAuthor(ee.footertext, ee.footericon).setDescription(`**${client.allEmojis.crown} My Prefix is: / or ${prefix}. Get started by typing </music play:898403953937612854> or </info help:898403953937612853>!**`)]})
        }
        return;
    }
